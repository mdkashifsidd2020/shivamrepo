...
public class CalculatorController {
    ...
    public String calculateProfit(
        ...
        // Calculate total costs using service
        double totalCost = calculatorService.calculateTotalCost(
                landPreparationCost, seedCost, fertilizerCost, sowingCost, 
                irrigationCost, pesticideCost, harvestingCost, postHarvestCost);
        ...
        model.addAttribute("landPreparationCost", landPreparationCost);
        model.addAttribute("seedCost", seedCost);
        model.addAttribute("fertilizerCost", fertilizerCost);
        model.addAttribute("sowingCost", sowingCost);
        model.addAttribute("irrigationCost", irrigationCost);
        model.addAttribute("pesticideCost", pesticideCost);
        model.addAttribute("harvestingCost", harvestingCost);
        model.addAttribute("postHarvestCost", postHarvestCost);
